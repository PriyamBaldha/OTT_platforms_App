...
class OTT_Platform_Page extends StatefulWidget {
  const OTT_Platform_Page({Key? key}) : super(key: key);

  @override
  State<OTT_Platform_Page> createState() => _OTT_Platform_PageState();
}

class _OTT_Platform_PageState extends State<OTT_Platform_Page> {
  double progress = 0;
  String url = "";
